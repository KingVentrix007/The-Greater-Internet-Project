class HttpeClient:
    ...
    async def start(self):
        if(self.use_edoi == True):
            ...
            # _init_connection() can remain sync if needed
    ...
    async def _receive_full_response(self) -> str:
...
# Nodes are sending back the path. But it is not picking them ip, like AT ALL. it isnt picking up the reponse